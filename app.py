    ...
    <main>
        ...
        <section id="bot" class="bot-info">
            <div class="container">
                ...
                <img src="/static/logo.jpg" alt="Logo O.P.S.D" class="bot-logo">
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="feature-list">
                    <div class="feature-item">
                        ...
                        <p>Protezione contro spam, raid e utenti malintenzionati.</p>
                    </div>
                    <div class="feature-item">
                        <h3>Personalizzazione</h3>
                        <p>Configura il bot secondo le esigenze del tuo server.</p>
                    </div>
                    <div class="feature-item">
                        <h3>Supporto 24/7</h3>
        ...
        <section id="server" class="server-info">
            <div class="container">
                ...
                <p>Unisciti alla nostra community per ricevere supporto e aggiornamenti.</p>
                <div class="buttons">
                    <a href="https://discord.gg/example" class="btn primary">Unisciti Ora</a>
                </div>
            </div>
        </section>
    </main>
    <footer>
        <p>&copy; 2023 O.P.S.D. Tutti i diritti riservati.</p>
    </footer>
</body>
